...
import { AuthSchema, AuthSchemaType } from '@/lib/validation/auth.schema'
import { signInWithPassword, signInWithOAuth } from '@/lib/supabase/client'
...
function SignInForm() {
  ...
  const isLoading = isSubmitting || isPending || isGoogleLoading
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs font-medium text-primary hover:text-primary-hover underline-offset-4 hover:underline"
              >
                Forgot password?
              </Link>
            </div>
